                    ...
                    {inviteLink ? (
                      <View style={styles.linkBox}>
                        ...
                        <View style={{ flexDirection: "row", gap: 10 }}>
                          ...
                          <TouchableOpacity style={[styles.copyBtn, { flex: 1, backgroundColor: DESIGN_COLORS.surface2, borderWidth: 1, borderColor: DESIGN_COLORS.accent }]} onPress={() => copyToClipboard(inviteLink)}>
                            <Text style={[styles.copyBtnText, { color: DESIGN_COLORS.accent }]}>🔗 Copy</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    ) : null}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: "900", color: DESIGN_COLORS.text },
  subtitle: { fontSize: 13, fontWeight: "800", color: DESIGN_COLORS.text3, marginTop: 4 },
  ...
  inviteOpenerText: { fontSize: 13, fontWeight: "900", color: DESIGN_COLORS.accent },
  disabledText: { opacity: 0.5 },
  scroll: { padding: 16, gap: 16 },

  card: { borderRadius: 18, borderWidth: 1, borderColor: DESIGN_COLORS.border, backgroundColor: DESIGN_COLORS.surface, padding: 16 },
  sectionTitle: { fontSize: 16, fontWeight: "900", color: DESIGN_COLORS.text, marginBottom: 16 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 16 },
  countText: { fontSize: 12, fontWeight: "700", color: DESIGN_COLORS.text3 },

  sheetInfo: { gap: 8 },
  sheetRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  sheetLabel: { fontSize: 13, fontWeight: "700", color: DESIGN_COLORS.text2 },
  sheetValue: { fontSize: 14, fontWeight: "800", color: DESIGN_COLORS.text },
  roleBadge: { backgroundColor: DESIGN_COLORS.accentGlow, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  roleBadgeText: { fontSize: 11, fontWeight: "900", color: DESIGN_COLORS.accent2, textTransform: "uppercase" },

  formRow: { flexDirection: "row", gap: 8 },
  input: { backgroundColor: DESIGN_COLORS.surface2, borderRadius: 12, borderWidth: 1, borderColor: DESIGN_COLORS.border, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, fontWeight: "700", color: DESIGN_COLORS.text },
  addButton: { backgroundColor: DESIGN_COLORS.accent, borderRadius: 12, paddingHorizontal: 16, justifyContent: "center", alignItems: "center" },
  addButtonText: { color: "#fff", fontWeight: "900", fontSize: 14 },

  memberItem: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: DESIGN_COLORS.border },
  memberName: { fontSize: 15, fontWeight: "800", color: DESIGN_COLORS.text },
  memberRelation: { fontSize: 12, color: DESIGN_COLORS.text3, fontWeight: "600", marginTop: 2 },
  systemBadge: { backgroundColor: "rgba(0,0,0,0.05)", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, marginLeft: 8 },
  systemBadgeText: { fontSize: 9, fontWeight: "800", color: DESIGN_COLORS.text3, textTransform: "uppercase" },
  spentLabel: { fontSize: 10, fontWeight: "700", color: DESIGN_COLORS.text3, textTransform: "uppercase", marginBottom: 2 },
  spentValue: { fontSize: 14, fontWeight: "900", color: DESIGN_COLORS.text },
  deleteBtn: { padding: 8, backgroundColor: "rgba(239,68,68,0.1)", borderRadius: 8 },
  deleteBtnText: { color: DESIGN_COLORS.red, fontSize: 11, fontWeight: "800" },
  empty: { padding: 20, alignItems: "center" },
  emptyText: { color: DESIGN_COLORS.text3, fontSize: 14, fontWeight: "600" },

  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "flex-end" },
  modal: { backgroundColor: DESIGN_COLORS.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, maxHeight: "80%" },
  modalHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 20 },
  modalTitle: { fontSize: 18, fontWeight: "900", color: DESIGN_COLORS.text },
  closeText: { fontSize: 15, color: DESIGN_COLORS.accent, fontWeight: "700" },
  modalBody: { gap: 12 },
  modalLabel: { fontSize: 12, fontWeight: "800", color: DESIGN_COLORS.text2, textTransform: "uppercase", marginBottom: 8, letterSpacing: 0.5 },
  modalInput: { backgroundColor: DESIGN_COLORS.surface2, borderRadius: 14, borderWidth: 1, borderColor: DESIGN_COLORS.border, padding: 14, fontSize: 15, color: DESIGN_COLORS.text, fontWeight: "600", marginBottom: 16 },
  roleRow: { flexDirection: "row", gap: 10, marginBottom: 20 },
  roleBtn: { flex: 1, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: DESIGN_COLORS.border, alignItems: "center", backgroundColor: DESIGN_COLORS.surface2 },
  roleBtnActive: { borderColor: DESIGN_COLORS.accent, backgroundColor: DESIGN_COLORS.accentGlow },
  roleBtnText: { fontSize: 14, fontWeight: "700", color: DESIGN_COLORS.text2 },
  roleBtnTextActive: { color: DESIGN_COLORS.accent },
  sendBtn: { backgroundColor: DESIGN_COLORS.accent, borderRadius: 14, paddingVertical: 16, alignItems: "center" },
  sendBtnText: { color: "#fff", fontSize: 15, fontWeight: "900" },
  linkBox: { marginTop: 24, padding: 16, backgroundColor: DESIGN_COLORS.surface2, borderRadius: 16, borderWidth: 1, borderStyle: "dashed", borderColor: DESIGN_COLORS.accent },
  linkTitle: { fontSize: 12, fontWeight: "800", color: DESIGN_COLORS.accent, marginBottom: 8 },
  linkText: { fontSize: 13, color: DESIGN_COLORS.text2, backgroundColor: "#fff", padding: 10, borderRadius: 8, marginBottom: 12 },
  copyBtn: { backgroundColor: DESIGN_COLORS.accent, paddingVertical: 10, borderRadius: 10, alignItems: "center" },
  ...
  guestTitle: { fontSize: 18, fontWeight: "900", color: DESIGN_COLORS.text, textAlign: "center" },
  guestText: { fontSize: 14, fontWeight: "600", color: DESIGN_COLORS.text2, textAlign: "center", lineHeight: 22 },
  signinBtn: {
    marginTop: 10,
